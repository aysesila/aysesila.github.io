...
sections:
  ...
  - block: cta-card
    ...
    content:
      ...
      text: |-
        This site is generated by **Hugo Blox Builder** — the open-source, Hugo-based website framework trusted by thousands of researchers.

        Easily build anything with modular blocks — no-code required.

        From landing pages, digital portfolios, and publications to academic resumés and research blogs.
      button:
        text: Learn More
